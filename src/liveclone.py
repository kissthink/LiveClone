...
directory or this partition, please choose another location for your work directory."))
        ...
        # Else we build LiveClone main module out of the running environment
            ...
            subprocess.call("""grub-mkimage -p /boot/grub -o /tmp/core.img -O i386-pc -m /tmp/memdisk.tar biosdisk btrfs ext2 fat iso9660 ntfs reiserfs xfs part_msdos part_gpt memdisk tar configfile loopback normal extcmd regexp test read echo""", shell=True)
